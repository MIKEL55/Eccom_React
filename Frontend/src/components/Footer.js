import {Place,LocalPhone,MailOutline} from '@mui/icons-material';



const Footer = () => {
    return (
        <footer className='p-8 grid gap-x-16 gap-y-4 md:grid-cols-3 mt-auto'>
        <div>
